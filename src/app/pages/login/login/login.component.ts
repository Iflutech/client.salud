...
export class LoginComponent {
  ...
  login() {
    ...
    setTimeout(() => {
      localStorage.setItem('sheet_sequence', 'MnxQZWRybyBCdXN0YW1hbnRlfFF1ZWxsYXZlY298UmVzaWRlbnRlfDh4OHwy');
      localStorage.setItem('token', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwidHlwZSI6ImNvbmR1Y3RvciIsImFkbWluIjp0cnVlLCJpYXQiOjE3NDM1NTg4MjMsImV4cCI6MTc0NDA5OTQyM30.iz3qxHC2VWv8e0H10s112xLIbI21SdAK6HUoxV_ozq4')
